    ...
    def show_info(self, result):
        try:
            ...
            if len(cls_name) > 10:
                ...
                cls_name = lst_cls_name[0][:7] + '..' + lst_cls_name[-1]
...
# --------------------------WEIGHT----------------------------
    ...
    # yolo = YOLOV8_infer(r'D:\Project\PCB_v2\PCB\yolov8_v2\code_yolov8_faster\ultralytics\runs\train\exp4\weights\best.pt', device, False)
