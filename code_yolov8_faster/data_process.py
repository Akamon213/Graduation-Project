...
########################################################################
# VOC数据集路径
voc_ann_path = r"D:\lg\BaiduSyncdisk\project\person_code\project_self\10_PCB_detect\data\PCB_DATASET\VOC\xml"
voc_img_path = r"D:\lg\BaiduSyncdisk\project\person_code\project_self\10_PCB_detect\data\PCB_DATASET\VOC\jpg"
# YOLO数据集路径
yolo_out_path = r"D:\lg\BaiduSyncdisk\project\person_code\project_self\10_PCB_detect\data\PCB_DATASET\VOC\yolo"
...
# VOC类别名称和对应的编号
classes = {"missing_hole": 0, "mouse_bite": 1, "open_circuit": 2, "short": 3, "spur": 4, "spurious_copper": 5}  # 根据实际情况修改
